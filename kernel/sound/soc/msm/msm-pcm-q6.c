...
static struct snd_pcm_hardware msm_pcm_hardware_playback = {
	...
	.channels_min =         1,
	.channels_max =         2,
	.buffer_bytes_max =     8*8*1024,//PLAYBACK_NUM_PERIODS * PLAYBACK_PERIOD_SIZE,
	.period_bytes_min =	8*1024,//PLAYBACK_PERIOD_SIZE,
	.period_bytes_max =     8*1024,//PLAYBACK_PERIOD_SIZE,
