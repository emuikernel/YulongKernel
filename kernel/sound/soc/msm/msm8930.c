...
static struct sitar_mbhc_config mbhc_cfg = {
	...
	/* fengchunsong.enable read acdb file.2012.09.27 */
	.read_fw_bin = true,
	.calibration = NULL,
...
static const struct snd_soc_dapm_route common_audio_map[] = {
	...
	{"AMIC3", NULL, "MIC BIAS1 External2"},
	{"MIC BIAS1 External", NULL, "Front Mic"},
	{"MIC BIAS1 External2", NULL, "Second Mic"},
	/*End youjin:2012-8030*/
...
#if 0
	/* delete by youjin ;because we did not use Dmic,it get to ground */
	/**
