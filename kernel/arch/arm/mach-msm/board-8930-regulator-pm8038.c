...
VREG_CONSUMERS(L11) = {
	...
	REGULATOR_SUPPLY("cam_vio_qc1",		"4-001a"),
	REGULATOR_SUPPLY("cam_vio_qc1",		"4-006c"),
	REGULATOR_SUPPLY("cam_vio_qc1",		"4-0048"),
	REGULATOR_SUPPLY("cam_vio_qc1",         "4-0020"),
	REGULATOR_SUPPLY("cam_vio_qc1",		"4-007a"),
};
VREG_CONSUMERS(L12) = {
...
msm8930_pm8038_gpio_regulator_pdata[] __devinitdata = {
	...
	GPIO_VREG(EXT_5V,     "ext_5v",     "ext_5v_en",     6, NULL),
	GPIO_VREG(EXT_OTG_SW, "ext_otg_sw", "ext_otg_sw_en", 7, "ext_5v"),
};
