...
static struct msm_mmc_pad_pull sdc3_pad_pull_off_cfg[] = {
	 ...
	 *
	 * Currently, our platform is 8860U, and the scene above haven't been
	 * found yet. So we modify the pad from PULL_UP to NO_PULL.
	 */
	 ...
	 *
	 * When sd card isn't present, the data pin's externel PULLUP is off,
	 * so the GPIO configurations are modified from PULL_UP to NO_PULL.
	 */
...
#else
	/* zhangchangchun  2012-11-10  about sd card read_only
	.wpswitch_gpio	= 66,
