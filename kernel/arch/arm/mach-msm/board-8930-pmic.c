...
static struct pm8xxx_gpio_init pm8038_gpios[] __initdata = {
	...
	/* yangliang mask and add below 20130106 */
	PM8038_GPIO_INPUT(2, PM_GPIO_PULL_DN),
	PM8038_GPIO_INPUT(5, PM_GPIO_PULL_DN),
	PM8038_GPIO_INPUT(6, PM_GPIO_PULL_DN),
	PM8038_GPIO_INPUT(7, PM_GPIO_PULL_DN),
	PM8038_GPIO_INPUT(10, PM_GPIO_PULL_DN),
	PM8038_GPIO_INPUT(11, PM_GPIO_PULL_DN),
	PM8038_GPIO_INPUT(12, PM_GPIO_PULL_DN),
};
...
static struct pm8xxx_adc_amux pm8038_adc_channels_data[] = {
	...
	{"pa_therm0", ADC_MPP_1_AMUX3, CHAN_PATH_SCALING1, AMUX_RSV1,
		ADC_DECIMATION_TYPE2, ADC_SCALE_PA_THERM},
	/*ykl add*/
	{"lcd_mv", ADC_MPP_1_AMUX6, CHAN_PATH_SCALING1, AMUX_RSV1,
		ADC_DECIMATION_TYPE2, ADC_SCALE_DEFAULT},
	/*end*/
};
...
#define MAX_VOLTAGE_MV		4190
/*modified by shchh beginning 20121231
 *for syn soc in BMS and is_charging_finished in pm8921_charge */
#define CHG_TERM_MA		150
/*modified by shchh ending 20121231*/
static struct pm8921_charger_platform_data pm8921_chg_pdata __devinitdata = {
	...
	.alarm_low_mv		= 3400,
	.alarm_high_mv		= 4000,
	.resume_voltage_delta	= 90,
	.resume_charge_percent	= 99,
	.term_current		= CHG_TERM_MA,
	.cool_temp		= -3, /*shchj modify 121228*/
	.warm_temp		= 48,
	.temp_check_period	= 1,
	...
	.rconn_mohm		= 18,
	/*added by shchj beginning 20121231*/
	.cold_thr		= PM_SMBC_BATT_TEMP_COLD_THR__LOW,
	.hot_thr		= PM_SMBC_BATT_TEMP_COLD_THR__HIGH,
	/*added by shchj ending 20121231*/
};
...
static struct pm8xxx_spk_platform_data pm8xxx_spk_pdata = {
	...
	/* by youjin changed the thresold=0010, as 2.8mv
	 * oldvalue 0x6 as 45.3mv
	 */
	.cd_ng_threshold	= 0x2,
...
static struct pm8921_bms_platform_data pm8921_bms_pdata __devinitdata = {
	...
	.shutdown_soc_valid_limit	= 5, /*modifed by shchj from 20*/
...
/* add vibrator device by huangqingjun  2012/08/24 */
struct pm8xxx_vibrator_platform_data vibrator_platform_data = {
...
static struct pm8038_platform_data pm8038_platform_data __devinitdata = {
	...
	.vibrator_pdata         = &vibrator_platform_data, /* zhangchangchun */
};

#ifdef CONFIG_MSM8930_MPP
/* add by youjin:to set the led-mpp configs */
static struct led_info ctp_backlight_info = {
	.name           = "led_mpp",
	.flags          = PM_MPP__I_SINK__LEVEL_40mA << 16 | PM_MPP_3,
};
...
void __init msm8930_init_pmic(void)
{
	if (socinfo_get_pmic_model() != PMIC_MODEL_PM8917) {
		...
		if (machine_is_msm8930_mtp())
			...
			/* modified by shchj, for charging display 20121031 */
...
#ifdef CONFIG_MSM8930_MPP
	/* add by youjin:to add device for led-mpp */
