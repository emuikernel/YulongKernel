...
#ifdef CONFIG_SOUND_FM2018
#include <linux/fm2018.h>
#endif

#ifdef CONFIG_TOUCH_ATMEL /* randy add atmel tw .HF 2012-08-09 */
#include <linux/atmel_i2c_ts.h>

#define ATMEL_TOUCH_I2C_ADDR	0x4A
#endif
...
#define M8930_PERSISTENT_RAM_SIZE	(SZ_1M)
#endif

#ifdef CONFIG_ANDROID_RAM_CONSOLE
#define M8930_RAM_CONSOLE_SIZE		(124*SZ_1K * 2)
#endif
...
static struct persistent_ram_descriptor pram_descs[] = {
	...
	{
		.name = "ram_console",
		.size = M8930_RAM_CONSOLE_SIZE,
	},
#endif
};

static struct persistent_ram msm8930_persistent_ram = {
	.size = M8930_PERSISTENT_RAM_SIZE,
	.num_descs = ARRAY_SIZE(pram_descs),
	.descs = pram_descs,
};

static void __init msm8930_ram_console_debug_reserve(void)
{
	struct persistent_ram *pram = &msm8930_persistent_ram;
	struct membank *bank = &meminfo.bank[0];

	pram->start = bank->start + bank->size - M8930_PERSISTENT_RAM_SIZE;

	persistent_ram_early_init(pram);
}
#else
static inline void __init msm8930_ram_console_debug_reserve(void)
{
	/* empty */
}
#endif
...
static void msm8930_ram_console_debug_init(void)
{
	int err;
...
#else
static inline void msm8930_ram_console_debug_init(void)
{
	/* empty */
}
#endif
...
{
	msm_reserve();
	msm8930_ram_console_debug_reserve(); /* zhangchangchun */
}
...
static struct wcd9xxx_pdata sitar_platform_data = {
	...
	.micbias = {
		...
		.cfilt1_mv = 1800,
		.cfilt2_mv = 2700, /* change by youjin from 1800 */
...
static struct wcd9xxx_pdata sitar1p1_platform_data = {
	...
	.micbias = {
		.ldoh_v = SITAR_LDOH_2P85_V,
		.cfilt1_mv = 1800,
		.cfilt2_mv = 2700, /* change by yanglin from 1800 */
		.bias1_cfilt_sel = SITAR_CFILT1_SEL,
		.bias2_cfilt_sel = SITAR_CFILT2_SEL,
		.bias1_cap_mode = MICBIAS_NO_EXT_BYP_CAP,
		.bias2_cap_mode = MICBIAS_NO_EXT_BYP_CAP,
...
#if (defined(CONFIG_BOARD_CP8860U) && !defined(CONFIG_BOARD_VER_P0)) || \
    defined(CONFIG_BOARD_CP8861U) || defined(CONFIG_BOARD_CP8870U)
	.has_48mhz_xo	= 1,
#else
	.has_48mhz_xo	= 0, /*fengchunsong */
#endif
};
...
/* akm8975 add by Jay.HF 2012-08-03 */
#ifdef CONFIG_SENSORS_AKM8975
...
/* tmd2771 add by Jay.HF 2012-08-03 */
#ifdef CONFIG_SENSORS_TMD2771
static struct i2c_board_info tmd2771_board_info[] __initdata = {
	{
		I2C_BOARD_INFO(TAOS_DRIVER_NAME, 0x39),
		.irq = MSM_GPIO_TO_INT(TAOS_GPIO_IRQ),
	},
};
#endif


/*ltr558als added 2012-11-20 */
#ifdef CONFIG_SENSORS_LTR558
static struct i2c_board_info ltr558als_board_info[] __initdata = {
	{
...
static struct pn544_i2c_platform_data pn544_pdata = {
	.irq_gpio = 35, /* NFC_IRQ */
	.ven_gpio = 8,  /* NFC_EN */
	.firm_gpio = 6, /* FIRM GPIO */
};
static struct i2c_board_info pn544_board_info[] __initdata = {
	{
...
/*lsm303d add by yanglin 2013-03-20*/
#ifdef CONFIG_SENSORS_LSM303D
static struct i2c_board_info lsm303d_board_info[] __initdata = {
	{
...
/* lis3dh add by Jay.HF 2012-08-03 */
#ifdef CONFIG_SENSORS_LIS3DH
static struct lis3dh_acc_platform_data lis3dh_acc_data = {
	.poll_interval = 5,
	.min_interval  = 10,
...
static struct i2c_board_info lis3dh_board_info[] __initdata = {
	{
		I2C_BOARD_INFO("lis3dh", 0x19),
		.platform_data = &lis3dh_acc_data,
		.irq = -1,
	},
};
#endif

/* bma250 add by Jay.HF 2012-09-03 */
...
/* bmm050 add by Jay.HF 2012-09-03 */
#ifdef CONFIG_SENSORS_BMM050
static struct i2c_board_info bmm050_board_info[] __initdata = {
	{
...
#define GPIO_CAMERA_KEY    97   /* add by shizhen 2012.7.30 */
...
static void __init msm8930_i2c_init(void)
{
	...
	msm8960_i2c_qup_gsbi5_pdata.keep_ahb_clk_on = 1;
#endif
...
#ifdef CONFIG_SOUND_FM2018
static struct regulator *fm2018_vreg;
static struct msm_xo_voter *xo_handle_d1;

int fm2018_power(int vreg_on)
{
	int rc;
	...
	if (!fm2018_vreg) {
		fm2018_vreg = regulator_get(NULL, "8038_l11");
		if (IS_ERR(fm2018_vreg)) {
			pr_err("%s: regulator_get(%s) failed (%ld)\n",
				__func__, "8038_l11", PTR_ERR(fm2018_vreg));
			return PTR_ERR(fm2018_vreg);
		}
	}

	if (!xo_handle_d1) {
		xo_handle_d1 = msm_xo_get(MSM_XO_TCXO_D1, "fm2018");
	...
	if (!!vreg_on) {
		rc = regulator_set_voltage(fm2018_vreg, 1800000, 1800000);
		if (rc) {
			pr_err("%s: regulator_set_voltage (l11) failed (%d)\n",
					__func__, rc);
			goto vreg_fail;
		}

		rc = regulator_enable(fm2018_vreg);
		if (rc) {
			pr_err("%s: regulator_enable (l11) failed (%d)\n",
					__func__, rc);
			goto vreg_fail;
		}
	} else{
		rc = regulator_disable(fm2018_vreg);
		if (rc) {
			pr_err("%s: regulator_disable(l11) failed (%d)\n",
					__func__, rc);
			goto vreg_fail;
		}
	}

	rc = vreg_on ? msm_xo_mode_vote(xo_handle_d1, MSM_XO_MODE_ON) :
...
vreg_fail:
	regulator_put(fm2018_vreg);
	fm2018_vreg = NULL;
	return rc;
}

int fm2018_priv_data_set(void *data)
{
	return 0;
}

static struct fm2018_platform_data fm2018_data = {
	.gpio_fm2018_rst = 0,
	.gpio_fm2018_irq_ana = 1,
	.gpio_fm2018_sda = 8,
	.gpio_fm2018_scl = 9,
	.priv_data_set = &fm2018_priv_data_set,
	.fm2018_power = &fm2018_power,
};

#define FM2018_I2C_SLAVE_ADDR 0x60

static struct i2c_board_info msm_i2c_gsbi1_fm2018_info[] = {
	{
		I2C_BOARD_INFO("fm2018", FM2018_I2C_SLAVE_ADDR),
		.platform_data = &fm2018_data,
	},
};
#endif
...
#ifdef CONFIG_TOUCH_ATMEL /* randy add atmel tw .HF 2012-08-09 */
static int atmel_qt602240_tw_init_gpio(int enable)
{
	if (enable)
		gpio_direction_output(TOUCH_RST_GPIO, 1);
	else
		gpio_direction_output(TOUCH_RST_GPIO, 0);

	pr_info("atmel qt602240 tw gpio init success\n");
	return 0;
}

/* randy add atmel tw .HF 2012-08-09 */
static struct atmel602240_platform_data atmel_platform_data = {
	.gpio_setup = atmel_qt602240_tw_init_gpio,
};
/* randy add atmel tw .HF 2012-08-09 */
static struct i2c_board_info __initdata atmel_touch_boardinfo[] = {
	{
		I2C_BOARD_INFO("qt602240_ts", ATMEL_TOUCH_I2C_ADDR),
...
#define YL_TW_INT_PIN	11
#define YL_TW_RESET_PIN	52
static int synaptics_s2202a_tw_init_gpio(void *gpio_data, bool configure)
{
	int rc = 0 ;
	struct syna_gpio_data *data = gpio_data;

	pr_debug("%s: synaptics s2202a tw gpio init start !\n", __func__);
	if (!configure) {
		pr_err("%s: Can't config gpio.\n", __func__);
		return -1;
	}

	/* randy add for 2202 gpio request 20121009 */
	rc = gpio_request(YL_TW_INT_PIN, "S2202_irq_gpio");
	if (rc) {
	...
	rc = gpio_request(YL_TW_RESET_PIN, "S2202_reset_gpio");
	if (rc) {
		pr_err("%s: reset gpio request failed (rc = %d)!\n",
			__func__, rc);
		gpio_free(YL_TW_INT_PIN);
		return -1;
	}
	mdelay(100);

	gpio_direction_output(YL_TW_RESET_PIN, 1);
	mdelay(10);
	gpio_direction_output(YL_TW_RESET_PIN, 0);
	mdelay(10);
	gpio_direction_output(YL_TW_RESET_PIN, 1);
	mdelay(100);

	mdelay(100);
	gpio_direction_input(data->gpio_number);
	pr_debug("..synaptics s2202a tw gpio init success..pc trace..\n");
	return 0;
}

#define THINSTYK_ADDR	0x20
#define THINSTYK_ATTN	18

static unsigned char thinstyk_btn_codes[] = {KEY_BACK, KEY_HOME, KEY_MENU};

static struct rmi_f19_button_map thinstyk_btn_map = {
	.nbuttons = ARRAY_SIZE(thinstyk_btn_codes),
	.map = thinstyk_btn_codes,
};

static struct syna_gpio_data thinstyk_gpiodata = {
	.gpio_number = YL_TW_INT_PIN,
...
static struct rmi_f11_virtualbutton_map tm1559_virtualbutton_map = {
...
static struct rmi_device_platform_data thinstyk_platformdata = {
	...
	.level_triggered = 1,
	.attn_gpio = YL_TW_INT_PIN,
	.attn_polarity = RMI_ATTN_ACTIVE_LOW,
	.gpio_data = &thinstyk_gpiodata,
	.gpio_config = synaptics_s2202a_tw_init_gpio,
	.button_map = &thinstyk_btn_map,
#ifdef CONFIG_RMI4_VIRTUAL_BUTTON
	.virtualbutton_map = &tm1559_virtualbutton_map,
#endif
};

static struct i2c_board_info __initdata rmi_s2202_touch_boardinfo[] = {
	{
...
static struct i2c_board_info __initdata ft5x0x_touch_boardinfo[] = {
	{
...
static struct i2c_registry msm8960_i2c_devices[] __initdata = {
#ifdef CONFIG_SOUND_FM2018
	{
		...
		msm_i2c_gsbi1_fm2018_info,
		ARRAY_SIZE(msm_i2c_gsbi1_fm2018_info),
	},
#endif
...
#ifdef CONFIG_TOUCH_ATMEL /* randy add atmel tw .HF 2012-08-09 */
	{
		...
		atmel_touch_boardinfo,
		ARRAY_SIZE(atmel_touch_boardinfo),
	},
#endif
...
#ifdef CONFIG_TOUCHSCREEN_FT5X06
	{
		I2C_SURF | I2C_FFA | I2C_FLUID,
		MSM_8930_GSBI3_QUP_I2C_BUS_ID,
		ft5x0x_touch_boardinfo,
		ARRAY_SIZE(ft5x0x_touch_boardinfo),
	},
#endif
...
#ifdef CONFIG_RMI4_I2C
	{
		I2C_SURF | I2C_FFA | I2C_FLUID,
		MSM_8930_GSBI3_QUP_I2C_BUS_ID,
		rmi_s2202_touch_boardinfo,
		ARRAY_SIZE(rmi_s2202_touch_boardinfo),
	},
#endif

#ifdef CONFIG_SENSORS_AKM8975 /* akm8975 add by Jay.HF 2012-08-03 */
	{
		I2C_SURF | I2C_FFA | I2C_FLUID,
...
#ifdef CONFIG_SENSORS_TMD2771 /* tmd2771 add by Jay.HF 2012-08-03 */
	{
		I2C_SURF | I2C_FFA | I2C_FLUID,
		MSM_8930_GSBI12_QUP_I2C_BUS_ID,
		tmd2771_board_info,
		ARRAY_SIZE(tmd2771_board_info),
	},
#endif

#ifdef CONFIG_SENSORS_LTR558 /* ltr558als */
	{
		I2C_SURF | I2C_FFA | I2C_FLUID,
		MSM_8930_GSBI12_QUP_I2C_BUS_ID,
		ltr558als_board_info,
		ARRAY_SIZE(ltr558als_board_info),
	},
#endif
...
#ifdef CONFIG_NFC_PN544
	{
...
#ifdef CONFIG_SENSORS_LSM303D
        {
                ...
                MSM_8930_GSBI12_QUP_I2C_BUS_ID,
                lsm303d_board_info,
                ARRAY_SIZE(lsm303d_board_info),
        },
#endif
#ifdef CONFIG_SENSORS_LIS3DH /* lis3dh add by Jay.HF 2012-08-03 */
	{
		I2C_SURF | I2C_FFA | I2C_FLUID,
		MSM_8930_GSBI12_QUP_I2C_BUS_ID,
		lis3dh_board_info,
		ARRAY_SIZE(lis3dh_board_info),
	},
#endif

#ifdef CONFIG_SENSORS_BMA250 /* bma250 add by Jay.HF 2012-09-03 */
	{
		I2C_SURF | I2C_FFA | I2C_FLUID,
		MSM_8930_GSBI12_QUP_I2C_BUS_ID,
		bma250_board_info,
...
#endif
#ifdef CONFIG_SENSORS_BMM050 /* bmm050 add by Jay.HF 2012-09-03 */
	{
		I2C_SURF | I2C_FFA | I2C_FLUID,
		MSM_8930_GSBI12_QUP_I2C_BUS_ID,
		bmm050_board_info,
		ARRAY_SIZE(bmm050_board_info),
	},
#endif
...
static void __init register_i2c_devices(void)
{
	...
	pr_debug("%s: synaptics s2202a tw i2c_register_board_info start !\n",
			__func__);
...
static void __init msm8930_cdp_init(void)
{
	...
	*/
	...
	msm8930_ram_console_debug_init();  /* zhangchangchun 2012/08/30 */
