...
static int msm_pm_debug_mask = 0x101;
module_param_named(
 ...
 *****************************************************************************/
extern void msm_gpiomux_sleep(void);
extern void msm_gpiomux_wakeup(void);
...
/* sunyonggang */
extern void suspend_resume_regulator(int sus_res);
...
static int msm_pm_enter(suspend_state_t state)
{
	...
	suspend_resume_regulator(0); /* sunyonggang */
