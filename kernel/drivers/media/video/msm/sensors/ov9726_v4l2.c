...
static int32_t ov9726_sensor_power_up(struct msm_sensor_ctrl_t *s_ctrl)
{
	int rc;
	...
	gpio_direction_output(info->dvdd_ldo_en, 1);
#endif
...
static int32_t ov9726_sensor_power_down(struct msm_sensor_ctrl_t *s_ctrl)
{
	int rc;
	struct msm_camera_sensor_info *info = NULL;
	...
	msleep(10);
#if !(defined(CONFIG_BOARD_CP8860U) && defined(CONFIG_BOARD_VER_P0))
	gpio_direction_output(info->dvdd_ldo_en, 0);
#endif
	gpio_direction_output(info->sensor_pwd, 0);
	gpio_direction_output(info->sensor_reset, 1);
	return rc;
...
static int32_t ov9726_sensor_setting(struct msm_sensor_ctrl_t *s_ctrl,
...
static struct msm_sensor_fn_t ov9726_func_tbl = {
	...
	.sensor_setting = ov9726_sensor_setting,
	.sensor_set_sensor_mode = msm_sensor_set_sensor_mode,
	.sensor_mode_init = msm_sensor_mode_init,
	.sensor_get_output_info = msm_sensor_get_output_info,
	.sensor_config = msm_sensor_config,
	.sensor_power_up = ov9726_sensor_power_up,
	.sensor_power_down = ov9726_sensor_power_down,
