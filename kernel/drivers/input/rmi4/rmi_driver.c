...
static int rmi_driver_resume(struct device *dev)
{
	...
	/*****start:pc deleted.12.05.17****
	if (!data->suspended)
		goto exit;
  ***end:pc deleted.12.05.17*******/
	pr_debug("rmi_driver_resume...\n");
...
static void rmi_driver_early_suspend(struct early_suspend *h)
{
	...
	*/
	...
	pr_debug("rmi_driver_early_suspend...\n");
...
static void rmi_driver_late_resume(struct early_suspend *h)
{
	...
	/*****start:thz deleted.12.05.17*******
	if (!data->suspended)
		goto exit;
 ***end:thz deleted.12.05.17*************/
	pr_debug("rmi_driver_late_resume...\n");
...
{
	printk(KERN_INFO "==enter in %s ==ck1\n", __func__);
