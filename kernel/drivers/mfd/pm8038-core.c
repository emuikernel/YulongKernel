...
/* sunyonggang */
extern int pm8xxx_resume_irq(void *data);
void msm_pm8038_show_resume_irq(void)
{
	struct pm8038 *pmic = pm8038_drvdata.pm_chip_data;
	pm8xxx_resume_irq(pmic->irq_chip);
}
