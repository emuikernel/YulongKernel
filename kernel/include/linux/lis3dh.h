 ...
 */
#define LIS3DH_MAGIC                    0x1D
#define LIS3DH_IOCTL_ACTIVE             _IOW(LIS3DH_MAGIC, 0x01, short)
#define LIS3DH_IOCTL_SET_DELAY          _IOW(LIS3DH_MAGIC, 0x02, short)
#define LIS3DH_IOCTL_GET_DELAY          _IOR(LIS3DH_MAGIC, 0x03, short)
#define LIS3DH_IOCTL_CALIBRATE          _IOW(LIS3DH_MAGIC, 0x04, short)
